...
public class ArbolAVL<K extends Comparable<K>, V> extends ArbolBinarioBusqueda<K, V>{
    ...
    public List<V> recorridoEnInOrdenParaValores() {
        ...
        if(!this.esArbolVacio()){
            ...
            meterEnInOrdenParaValores(pilaDeNodos, this.raiz);
            do{
                NodoBinario<K, V> nodoActual = pilaDeNodos.pop();
                recorrido.add(nodoActual.getValor());
                if(!nodoActual.esVacioHijoDerecho()){
                    meterEnInOrdenParaValores(pilaDeNodos, nodoActual.getHijoDerecho());
                } 
    ...
    public boolean editarCliente(K clave,V nuevoCliente) {
